...
${e}
  ...
  "temperature": 0.7
  }'`}),(0,t.jsx)(s.Button,{type:"text",icon:(0,t.jsx)(i.CopyOutlined,{}),style:{position:"absolute",right:"8px",top:"8px"},size:"small",onClick:()=>{navigator.clipboard.writeText(c||""),a.default.success("已复制到剪贴板")}})]})]})]}),(0,t.jsx)("div",{className:"mt-4 text-right w-full",children:(0,t.jsxs)("p",{className:"text-sm text-gray-500",children:["Found an error? File an issue"," ",(0,t.jsx)("a",{href:"https://github.com/BerriAI/litellm/issues",target:"_blank",rel:"noopener noreferrer",children:"here"}),"."]})})]})}])},715288,e=>{"use strict";var t=e.i(843476),r=e.i(662316),s=e.i(135214);e.s(["default",0,()=>{let{accessToken:e}=(0,s.default)();return(0,t.jsx)(r.default,{accessToken:e})}])}]);